...
<body>
    ...
    <form name="mail" method="post" action="database-write.php" >
        ...
        <input type="text" name="iname" required="required"><br>
        ...
        <input type="email" name="iemail" required="required"><br>
        ...
        Message:<br>
            ...
            <textarea placeholder="" required="required" name="imessage"></textarea><br>
